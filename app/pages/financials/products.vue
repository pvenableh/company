  ...
  <LayoutPageContainer>
    ...
    <div class="flex flex-wrap gap-3 mb-6">
      <div class="relative flex-1 min-w-[200px]">
        ...
        <input
          v-model="search"
          class="w-full rounded-full glass-field pl-9 pr-3 py-2 text-sm"
          placeholder="Search products..."
        />
      </div>
      <select v-model="typeFilter" class="rounded-full glass-field px-3 py-2 text-sm">
        <option value="all">All Types</option>
        <option value="Service">Services</option>
        <option value="Product">Products</option>
      </select>
      <select v-model="sortBy" class="rounded-full glass-field px-3 py-2 text-sm">

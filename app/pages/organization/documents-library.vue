...
const initialTab: TabKey = (() => {
	...
	return typeof q === 'string' && VALID_TABS.includes(q as TabKey) ? (q as TabKey) : 'blocks';
})();
...
function phaseCount(t: ServiceTemplate) {
	...
	// Pre-migration legacy free-text rows show 0 phases — a visible hint
	// to the operator that the row needs the scope rebuilt structurally.
	return 0;
}

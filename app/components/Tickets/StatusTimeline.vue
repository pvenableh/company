...
<template>
	<div class="w-full flex items-center justify-center px-8 md:px-20">
		<div class="relative flex w-full items-center justify-between max-w-[600px]">
			<div class="absolute top-1/2 left-0 right-0 h-1 bg-border transform -translate-y-1/2"></div>
			<div
			...
			<div
				...
				:class="{
					'border-[var(--cyan)] bg-muted shadow': statuses.indexOf(currentStatus) >= index,
					'border-border bg-white': statuses.indexOf(currentStatus) < index,
				}"
				:title="status"
			>
				<div

...
// Empty state: true when all columns have zero tickets and not loading
const hasNoTickets = computed(() => {
	return columns.every((col) => !localTickets.value[col.id]?.length);
});

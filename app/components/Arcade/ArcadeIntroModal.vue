...
const slides: IntroSlide[] = [
  ...
  },
  {
    ...
    body: 'Every completed action earns Earnest Points — those "+EP" pops you see. Bigger moves earn more:',
    rows: [
      { label: 'Sign a contract', value: '+25' },
      { label: 'Ship a project', value: '+25' },
      { label: 'Win a deal', value: '+20' },
      { label: 'Get paid on time', value: '+15' },
      { label: 'Deliver a project on time', value: '+15' },
      { label: 'Close a ticket', value: '+10' },
      { label: 'Add a contact', value: '+10' },
      { label: 'Qualify a lead', value: '+10' },
    ],
  },
  {
    icon: 'lucide:list-checks',
    title: 'Everyday actions count too',
    body: 'The steady work adds up. Messages, comments and your daily check-in earn EP quietly — no pop, but the Earnest mark gives a nod:',
    rows: [
      { label: 'Send an invoice', value: '+5' },
      { label: 'Hold a meeting', value: '+5' },
      { label: 'Advance a lead / follow up', value: '+5' },
      { label: 'Scan a card in CardDesk', value: '+5' },
      { label: 'Complete a task', value: '+3' },
      { label: 'Log an expense', value: '+3' },
      { label: 'Publish a social post', value: '+3' },
      { label: 'Daily check-in', value: '+3' },
      { label: 'Message or comment (quiet)', value: '+2' },
    ],
  },
  {
    icon: 'lucide:target',

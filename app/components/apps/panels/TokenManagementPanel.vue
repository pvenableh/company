<!--
  TokenManagementPanel — slide-over for AI token usage + top-up. Singleton
  (no per-id route), so `id` is a sentinel `'_'`. Replaces the
  OrganizationTokenManagementModal bottom sheet; opened via
  openTokenModal() (useTokenModal), which pushes this panel.
-->

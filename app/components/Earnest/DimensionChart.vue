...
const dimensionList = computed(() => [
	{ key: 'followThrough', label: 'Follow-Through', value: props.dimensions.followThrough, max: 25, colorClass: 'bg-success' },
	{ key: 'crm', label: 'CRM', value: props.dimensions.crm ?? 0, max: 20, colorClass: 'bg-destructive' },
	...
	{ key: 'proactivity', label: 'Proactivity', value: props.dimensions.proactivity, max: 10, colorClass: 'bg-warning' },
	{ key: 'depth', label: 'Depth', value: props.dimensions.depth, max: 10, colorClass: 'bg-info' },
]);
</script>

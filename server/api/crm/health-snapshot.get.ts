  ...
  try {
    ...
    return {
      ...
      metrics: {
        ...
        projectsByStatus: ctx.projects.byStatus,
        avgCompletionDays: ctx.projects.avgCompletionDays,
        tasksTotal: ctx.projects.tasksTotal,
        tasksCompleted: ctx.projects.tasksCompleted,
        tasksPending: ctx.projects.tasksPending,
        overdueTickets: ctx.tickets.overdue.length,
        unassignedTickets: ctx.tickets.unassigned,
        ticketsByStatus: ctx.tickets.byStatus,
        ticketsByPriority: ctx.tickets.byPriority,
        ...
        avgInvoiceValue: ctx.invoices.avgInvoiceValue,

...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    notices.sort((a, b) => priorityOrder[a.priority] - priorityOrder[b.priority]);
...
async function generateClientNotices(
...
async function generateProjectNotices(
...
async function generateInvoiceNotices(

		...
		<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
			<div class="border-r border-gray-200 pr-4">
				<div class="flex items-center">
					...
					<UTooltip
						text="The average time it takes you to resolve tickets from creation to completion. Lower times indicate faster resolution. The comparison shows how your performance compares to the team average."
					>
						<UIcon
			...
			<div class="border-r border-gray-200 px-4">
				<div class="flex items-center">
					...
					<UTooltip
						text="The percentage of your assigned tickets that have been completed. Higher percentages indicate more efficient resolution. The comparison shows how your rate compares to the team average."
					>
						<UIcon
							name="i-heroicons-information-circle"
							class="w-4 h-4 text-gray-400 hover:text-gray-600 cursor-help ml-1"
			...
			<div class="pl-4">
				<div class="flex items-center">
					...
					<UTooltip
						text="The average number of actions (comments, task updates, status changes) you perform per ticket. Higher numbers may indicate more thorough handling of tickets. The comparison shows how your activity level compares to the team average."
					>
						<UIcon
							name="i-heroicons-information-circle"
							class="w-4 h-4 text-gray-400 hover:text-gray-600 cursor-help ml-1"

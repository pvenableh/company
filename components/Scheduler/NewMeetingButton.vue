<!-- components/Scheduler/NewMeetingButton.vue -->
<script setup>
		...
		if (form.is_video) {
			await $fetch('/api/video/create-room', {
				...
				body: {
					...
					invitee_name: form.invitee_name || undefined,
					invitee_email: form.invitee_email || undefined,
					invitee_phone: form.invitee_phone || undefined,
					invite_method: form.invite_method,
				},
			});
			...
			<UCard>
				...
				<form @submit.prevent="saveMeeting" class="space-y-4">
					...
					<UFormGroup label="Description">
						<UTextarea v-model="form.description" placeholder="Meeting description" rows="2" />
					</UFormGroup>
